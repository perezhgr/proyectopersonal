    ...
    <div class="site-wrapper-inner">
      ...
      <div class="container marketing">
       <div class="row" >
        ...
        <div class="col-lg-3">
          <img class="zoom img-circle zoom" src="{$empresa.path}" style="width: 140px; height: 140px;"><br><br>
          <!-- First Panel -->
          <div class="panel panel-primary">
            <div class="panel-heading">
             <h4 class="panel-title"
             data-toggle="collapse" 
             data-target="#{$empresa.id_empresa}">
             {$empresa.titulo}
           </h4>
         </div>
         <div id="{$empresa.id_empresa}" class="panel-collapse collapse">
